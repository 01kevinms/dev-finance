...
const Home = () => {
    ...
    // READONLYARRAY array de apenas leitura
                ...
                <section className="py-12 md:py-20">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                        <div>
                            ...
                            <div className="flex flex-col sm:flex-row space-y- sm:space-y-0 sm:sapce-x-4">
                                <Button className="text-center px-6 py-3" onClick={()=>navigate('/login')}>comecar agora</Button>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-12 md:py-20 bg-gray-900 rounded-xl">
                    <div className="container-app">
                        <div className="text-center mb-12">
                            <h2 className=" text-3cl font-bold text-white mb-4">
...
<section className="py-12 md:py20">
...
Comece a usar o DevFinance hoje mesmo e tenha o controle total sobre seu dinheiro. É
