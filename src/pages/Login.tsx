...
if (authState.user && !authState.loading) {
    ...
    return (
        <div className=" min-h-screen fle items-center justify-center bg-gray-200 py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full space-y-8">
                ...
                <main className="mt-8 bg-white py-8 px-4 shadow-md rounded-lg sm:px10 space-y-6">
